...
from align_anything.utils.utils.constants.template_verbs import (
    GOTO_POINT_VERBS,
    GOTO_VERBS,
    PICKUP_VERBS,
)
from align_anything.utils.utils.objaverse_annotation import get_objaverse_annotations
from align_anything.utils.utils.synset_utils import (
...
# )["train"].data
SYNSET_TO_BEST_LEMMA = json.load(open('align_anything/utils/utils/synset_to_best_lemma.json'))
